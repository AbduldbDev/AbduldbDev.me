...
const TechBadge = ({ tech }) => {
  ...
  return (
    <div className="group relative overflow-hidden px-3 py-2 md:px-4 md:py-2.5 bg-gradient-to-r from-orange-400/10 to-yellow-400/10 rounded-xl border border-orange-500/10 hover:border-orange-500/30 transition-all duration-300 cursor-default">
      <div className="absolute inset-0 bg-gradient-to-r from-orange-400/0 to-yellow-400/0 group-hover:from-orange-400/10 group-hover:to-yellow-400/10 transition-all duration-500" />
      <div className="relative flex items-center gap-1.5 md:gap-2">
        <Icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-orange-400 group-hover:text-orange-300 transition-colors" />
...
const FeatureItem = ({ feature }) => {
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-orange-100/5 transition-all duration-300 border border-transparent hover:border-orange-300/10">
...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-4 p-3 md:p-4 bg-[#251108d5] rounded-xl overflow-hidden relative">
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-orange-700/20 opacity-40 blur-2xl z-0" />
      ...
      <div className="relative z-10 flex items-center space-x-2 md:space-x-3 bg-white/5 p-2 md:p-3 rounded-lg border border-orange-500/20 transition-all duration-300 hover:scale-105 hover:border-orange-500/50 hover:shadow-lg">
        ...
        <div className="flex-grow">
          ...
          <div className="text-[10px] md:text-xs text-orange-100/70">
            Total Technology
          </div>
        </div>
      </div>
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/AbdulDeBorja09",
      };
    ...
    return (
      <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center">
        <div className="text-center space-y-6 animate-fadeIn">
          <div className="w-16 h-16 md:w-24 md:h-24 mx-auto border-4 border-orange-500/20 border-t-orange-400 rounded-full animate-spin" />
          <h2 className="text-xl md:text-3xl font-bold text-orange-100">
            Loading Project...
          </h2>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#000000] px-[2%] sm:px-0 relative overflow-hidden">
      ...
      <div className="fixed inset-0">
        <div className="absolute -inset-[10px] opacity-20">
          ...
          <div className="absolute -bottom-8 left-20 w-72 md:w-96 h-72 md:h-96 bg-orange-600 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000" />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              <div className="space-y-4 md:space-y-6">
                <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-r from-orange-200 via-purple-200 to-pink-200 bg-clip-text text-transparent leading-tight">
                  {project.Title}
                </h1>
                <div className="relative h-1 w-16 md:w-24">
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full animate-pulse" />
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full blur-sm" />
                </div>
              </div>

              <div className="prose prose-invert max-w-none">
                <div className="text-base md:text-lg text-gray-200/90 leading-relaxed">
                  {project.Description}
                </div>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                <h3 className="text-lg md:text-xl font-semibold text-white/90 mt-[3rem] md:mt-0 flex items-center gap-2 md:gap-3">
                  <Code2 className="w-4 h-4 md:w-5 md:h-5 text-orange-500" />
                  Technologies Used
                </h3>
