        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <a
              ...
              className="text-xl font-bold bg-gradient-to-r from-[#ff6a00] to-[#ffb347] bg-clip-text text-transparent"
            >
              AbduldbDev
            </a>
          </div>
            ...
            <div className="ml-8 flex items-center space-x-8">
              {navItems.map((item) => (
                ...
                >
                  ...
                  <span
                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#ff6a00] to-[#ffb347] transform origin-left transition-transform duration-300 ${
                      activeSection === item.href.substring(1)
                        ? "scale-x-100"
