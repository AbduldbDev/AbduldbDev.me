...
function TabPanel({ children, value, index, ...other }) {
  return (
    ...
    >
      {value === index && (
        <Box sx={{ p: { xs: 1, sm: 3 } }}>
          <Box>{children}</Box> {/* ✅ This fixes the nested <div> warning */}
        </Box>
      )}
    </div>
  );
...
const techStacks = [
  { icon: "svg/html.svg", language: "HTML" },
  { icon: "svg/css.svg", language: "CSS" },
  { icon: "svg/sass.svg", language: "SASS" },
  { icon: "svg/bootstrap.svg", language: "Bootstrap" },
  { icon: "svg/tailwind.svg", language: "Tailwind" },
  { icon: "svg/javascript.svg", language: "JavaScript" },
  { icon: "svg/laravel.svg", language: "Laravel" },
  { icon: "svg/next-js.svg", language: "Next JS" },
  { icon: "svg/reactjs.svg", language: "ReactJS" },
  { icon: "svg/reactjs.svg", language: "React Native" },
  { icon: "svg/php.svg", language: "PHP" },
  { icon: "svg/python.svg", language: "Python" },
  { icon: "svg/firebase.svg", language: "Firebase" },
  { icon: "svg/sql.svg", language: "Mysql" },
  { icon: "svg/vercel.svg", language: "Vercel" },
  { icon: "svg/arduino.svg", language: "Arduino" },
  { icon: "svg/git.svg", language: "Git" },
  { icon: "svg/vscode.svg", language: "VsCode" },
];
